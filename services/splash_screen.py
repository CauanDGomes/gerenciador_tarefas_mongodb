...
class SplashScreen:
    ...
    def display(self):
        ...
        print("  - Amon Brandao Lares (amonLares)")
        print("  - Cauan Henrique Dasmascena Gomes")
        print("  - Eduardo Rangel Malaquias Rodrigues")
        print("  - Guilherme Paiva (@GuilhermeDSpaiva)")
        print("  - Juliano De Andrade Dantas Rodrigues (JulianoDADR)")
        print("  - Julia Soares Gomes Paiva (@juuuhhhhhhh)")
        print("  - Ruabiale Filho (rubiale18)")
        print("-" * 70)
        print()
